...
const UserDetails = (props) => {
  ...
  // getting our users detail from the state
 ...
 // model functions
  ...
  const deleteUser = async () => {
    const id = user.id;
    try {
      // api call with id parameter passed as required
      const response = await fetch(`https://users-beta.vercel.app/api/users/${id}/`, {
        ...
        if (response.ok) {
          ...
          // if request is successful navigate to detailss
        }
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      // update endpoint declared with id parameter passed as required
      const response = await fetch(`https://users-beta.vercel.app/api/users/${id}/`, {
        method: 'PUT',
